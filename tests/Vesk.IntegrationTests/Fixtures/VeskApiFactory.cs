...
/// </summary>
public class VeskApiFactory : WebApplicationFactory<Program>, IAsyncLifetime
{
    private readonly string _dbName = $"vesk_test_{Guid.NewGuid():N}";

    private string ConnectionString =>
        $"Host=localhost;Port=5432;Database={_dbName};Username=vesk;Password=vesk_dev_pass;Include Error Detail=true";
