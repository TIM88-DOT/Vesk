...
/// </summary>
public class AuthEndpointsTests : IClassFixture<VeskApiFactory>
{
    ...
    public AuthEndpointsTests(VeskApiFactory factory)
    {
    ...
    public async Task Refresh_NoCookie_Returns401()
    {
        ...
        HttpClient freshClient = new VeskApiFactory().CreateClient();
